...
#define SQ_READ_BASE_ADDRESS_A0_REG  	0x6C
/** Card Control Registers : Read SQ base address A1 register */
#define SQ_READ_BASE_ADDRESS_A1_REG  	0x6D
...
#define CARD_FW_STATUS0_REG		0x88
/** Firmware status 1 register (SCRATCH0_1) */
#define CARD_FW_STATUS1_REG		0x89
/** Rx length register (SCRATCH0_2) */
#define CARD_RX_LEN_REG			0x8A
/** Rx unit register (SCRATCH0_3) */
#define CARD_RX_UNIT_REG		0x8B
