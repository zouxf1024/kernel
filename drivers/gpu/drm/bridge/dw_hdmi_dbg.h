#ifndef _ROCKCHIP_HDMI_HW_H
#define _ROCKCHIP_HDMI_HW_H

#define HDMI_INT_USE_POLL		1 /* TODO Daisen wait to modify */

/* GRF HDMI IOMUX register */
#define GRF_SOC_CON6			0x025c
#define HDMI_SEL_VOP_LIT		(1 << 4)

#define GRF_GPIO7CL_IOMUX		0x0074
#define GPIO7C3_IOMUX_HDMI_ENABLE	(3UL << 28)
#define GPIO7C3_IOMUX_HDMI_SDA		(2UL << 12)

#define GRF_GPIO7CH_IOMUX		0x0078
#define GPIO7C4_IOMUX_HDMI_ENABLE	(3UL << 16)
#define GPIO7C4_IOMUX_HDMI_SCL		(2UL << 0)

/* HDMI TX Controller */
#define HDMI_TX_REG_MSK			0xff
#define HDMI_TX_REG_CLR			0x00

/* Color Space Convertion Mode */
enum {
	 /* RGB 0-255 input to RGB 16-235 output for 8bit */
	CSC_RGB_0_255_TO_RGB_16_235_8BIT,
	 /* RGB 0-255 input to RGB 16-235 output for 8bit */
	CSC_RGB_0_255_TO_RGB_16_235_10BIT,
	 /* RGB 0-255 input to YCbCr 16-235 output for BT601 8bit*/
	CSC_RGB_0_255_TO_ITU601_16_235_8BIT,
	 /* RGB 0-255 input to YCbCr 16-235 output for BT601 10bit*/
	CSC_RGB_0_255_TO_ITU601_16_235_10BIT,
	/* RGB 0-255 input to YCbCr 16-235 output for BT709  8bit*/
	CSC_RGB_0_255_TO_ITU709_16_235_8BIT,
	 /* RGB 0-255 input to YCbCr 16-235 output for BT709 10bit*/
	CSC_RGB_0_255_TO_ITU709_16_235_10BIT,
	/* YCbCr 16-235 input to RGB 16-235 output for BT601 8bit*/
	CSC_ITU601_16_235_TO_RGB_16_235_8BIT,
	/* YCbCr 16-235 input to RGB 16-235 output for BT709 8bit*/
	CSC_ITU709_16_235_TO_RGB_16_235_8BIT,
	/* YCbCr 16-235 input to RGB 0-255 output for BT601 8bit*/
	CSC_ITU601_16_235_TO_RGB_0_255_8BIT,
	/* YCbCr 16-235 input to RGB 0-255 output for BT709 8bit*/
...
#define m_HPD				(1 << 0)
#define m_RX_SENSE_MSK			(m_RX_SENSE0 | \
					 m_RX_SENSE1 | \
					 m_RX_SENSE2 | \
					 m_RX_SENSE3)
...
#define MUTE_WAKEUP_INT			(1 << 1)
#define MUTE_ALL_INT			(1 << 0)
...
#define m_FC_RGC_YCC_2			(1 << 7) /* HDMI2.0 TX */
...
#define m_FC_AVIVID_H			(1 << 7) /* HDMI2.0 TX */
...
#define m_FC_LFE_PBL			(0x03 << 5) /* HDMI1.4 TX */
...
/*depend on PHY_GEN2 = 0 & PHY_EXTERNAL = 0 */
#define m_PWRDN_EN			(1 << 7)
#define v_PWRDN_EN(n)			(((n) & 0x01) << 7)

/*depend on PHY_GEN2 = 0 & PHY_EXTERNAL = 0 */
#define m_TMDS_EN			(1 << 6)
#define v_TMDS_EN(n)			(((n) & 0x01) << 6)

/* depend on PHY_MHL_COMB0 = 1*/
#define m_SVSRET_SIG			(1 << 5)
...
/* depend on PHY_GEN2=1 or PHY_EXTERNAL=1 */
...
#define I2CM_BUF0			0x7e20	/* buff0~buff7 */
