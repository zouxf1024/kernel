...
#define     RKVDEC_COLMV_USE_FLAG_REF               BIT(3)
#define     RKVDEC_BASE_REFER(x)                    (((x) & 0xfffffff) << 4)
...
#define     RKVDEC_VP9LAST_BASE(x)                  (((x) & 0xfffffff) << 4)
#define RKVDEC_REG_VP9_REFERGOLDEN_BASE             0x030
#define     RKVDEC_VP9GOLDEN_BASE(x)                (((x) & 0xfffffff) << 4)
#define RKVDEC_REG_VP9_REFERALFTER_BASE             0x034
#define     RKVDEC_VP9ALFTER_BASE(x)                (((x) & 0xfffffff) << 4)
#define RKVDEC_REG_VP9COUNT_BASE                    0x038
#define     RKVDEC_VP9COUNT_UPDATE_EN               BIT(0)
#define     RKVDEC_VP9COUNT_BASE(x)                 (((x) & 0x1fffffff) << 3)
#define RKVDEC_REG_VP9_SEGIDLAST_BASE               0x03C
#define     RKVDEC_VP9SEGIDLAST_BASE(x)             (((x) & 0xfffffff) << 4)
#define RKVDEC_REG_VP9_SEGIDCUR_BASE                0x040
#define     RKVDEC_VP9SEGIDCUR_BASE(x)              (((x) & 0xfffffff) << 4)
#define RKVDEC_REG_VP9_FRAME_SIZE(i)                ((i) * 0x04 + 0x044)
#define     RKVDEC_VP9_FRAMEWIDTH(x)                ((x) & 0xffff)
#define     RKVDEC_VP9_FRAMEHEIGHT(x)               (((x) & 0xffff) << 16)
#define RKVDEC_VP9_SEGID_GRP(i)                     ((i) * 0x04 + 0x050)
#define     RKVDEC_SEGID_ABS_DELTA                  BIT(0)
#define     RKVDEC_SEGID_FRAME_QP_DELTA_EN          BIT(1)
#define     RKVDEC_SEGID_FRAME_QP_DELTA_EN(x)       (((x) & 0x1ff) << 2)
#define     RKVDEC_SEGID_FRAME_LOOPFILTER_VALUE_EN  BIT(11)
#define     RKVDEC_SEGID_FRAME_LOOPFILTER_VALUE(x)  (((x) & 0x7f) << 12)
#define     RKVDEC_SEGID_REFERINFO_EN               BIT(19)
#define     RKVDEC_SEGID_REFERINFO(x)               (((x) & 0x03) << 20)
#define     RKVDEC_SEGID_FRAME_SKIP_EN              BIT(22)
...
#define     RKVDEC_REF_DELTAS_LASTFRAME(x)          ((x) & 0xfffffff)
#define RKVDEC_VP9_INFO_LASTFRAME                   0x084
#define     RKVDEC_MODE_DELTAS_LASTFRAME(x)         ((x) & 0x3fff)
...
#define     RKVDEC_INTERCMD_BASE(x)                 (((x) & 0xfffffff) << 4)
...
#define     RKVDEC_HOR_VIRSTRIDE(x)                 ((x) & 0x1ff)
#define     RKVDEC_HOR_VIRSTRIDE(x)                 (((x) & 0x1ff) << 16)
...
#define     RKVDEC_RLCWRITE_BASE(x)                 (((x) & 0x1ffffff) << 3)
#define RKVDEC_REG_PPS_BASE                         0x0A8
#define     RKVDEC_PPS_BASE(x)                      (((x) & 0xfffffff) << 4)
#define RKVDEC_REG_RPS_BASE                         0x0AC
#define     RKVDEC_RPS_BASE(x)                      (((x) & 0xfffffff) << 4)
...
#define     RKVDEC_H264_ERRINFO_BASE(x)             (((x) & 0x1ffffff) << 3)
