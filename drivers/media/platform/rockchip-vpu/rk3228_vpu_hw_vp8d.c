...
#ifdef DEBUG
static void rk3228_vp8d_dump_hdr(struct rockchip_vpu_ctx *ctx)
{
...
#else
static inline void rk3228_vp8d_dump_hdr(struct rockchip_vpu_ctx *ctx) {}
#endif

static void rk3228_vp8d_prob_update(struct rockchip_vpu_ctx *ctx)
{
	const struct v4l2_ctrl_vp8_frame_hdr *hdr = ctx->run.vp8d.frame_hdr;
 ...
 * set loop filters
 */
static void rk3228_vp8d_cfg_lf(struct rockchip_vpu_ctx *ctx)
{
	const struct v4l2_ctrl_vp8_frame_hdr *hdr = ctx->run.vp8d.frame_hdr;
 ...
 */
static void rk3228_vp8d_cfg_qp(struct rockchip_vpu_ctx *ctx)
{
	const struct v4l2_ctrl_vp8_frame_hdr *hdr = ctx->run.vp8d.frame_hdr;
	struct rockchip_vpu_dev *vpu = ctx->dev;
	int i;
 ...
 */
static void rk3228_vp8d_cfg_parts(struct rockchip_vpu_ctx *ctx)
{
	const struct v4l2_ctrl_vp8_frame_hdr *hdr = ctx->run.vp8d.frame_hdr;
	struct rockchip_vpu_dev *vpu = ctx->dev;
 ...
 */
static void rk3228_vp8d_cfg_tap(struct rockchip_vpu_ctx *ctx)
{
	const struct v4l2_ctrl_vp8_frame_hdr *hdr = ctx->run.vp8d.frame_hdr;
	struct rockchip_vpu_dev *vpu = ctx->dev;
	struct vp8d_reg reg;
...
/* set reference frame */
static void rk3228_vp8d_cfg_ref(struct rockchip_vpu_ctx *ctx)
{
	u32 reg;
...
void rk3228_vpu_vp8d_run(struct rockchip_vpu_ctx *ctx)
{
	...
	rk3228_vp8d_cfg_lf(ctx);
	rk3228_vp8d_cfg_qp(ctx);
	rk3228_vp8d_cfg_parts(ctx);
	rk3228_vp8d_cfg_tap(ctx);
	rk3228_vp8d_cfg_ref(ctx);
	rk3228_vp8d_cfg_buffers(ctx);
