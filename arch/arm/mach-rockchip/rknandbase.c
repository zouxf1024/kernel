...
int rknand_get_reg_addr(unsigned long *pNandc0,
	unsigned long *pNandc1, unsigned long *pSDMMC0,
	unsigned long *pSDMMC1, unsigned long *pSDMMC2)
{
...
static int __init rknand_part_init(void)
{
	...
	dev_err(n_dev, "rknand_driver:ret = %x\n", ret);
	return ret;
}
